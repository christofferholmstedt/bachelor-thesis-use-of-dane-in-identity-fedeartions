...
DANE is a concept where the goal is to put trust in the DNS and DNSSEC infrastructure as a common trusted authority.
...
Some parts in the report will touch the topic of the TLS or SSL handshaking process but will not go into further detail.
