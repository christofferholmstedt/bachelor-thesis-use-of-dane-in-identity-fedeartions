...
We were tasked specifically to look at the data integrity part of SAML2 and how X.509 certificates are used and in the end, if and how, it would be possible to improve security with the help of DANE.
...
We have listed some solutions such as using CERT resource records and perhaps locating the correct one with some NAPTR resource record procedures.
...
Another requirement should be to publish the certificate within the DNS/DNSSEC infrastructure.
...
How does an entitiy that has recieved a signed metadata file locate the correct certificate within the DNS/DNSSEC system?
