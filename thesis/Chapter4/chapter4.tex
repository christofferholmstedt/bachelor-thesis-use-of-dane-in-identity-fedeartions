...
With that said, a trust relationship is built and the data integrity is up and running after the first certificate exchange has been made. 
The question is, how can this certificate exchange be made securely? 
