...
% Perhaps not viable as a standard cause it's still not possible to determine if this is the future and will be really big like the move from statis hosts files to DNS, or it's just 
% a temporary solution for this decade.
% TODO: Add this to chapter 5 for future work...it might be possible to create some generalization about federated certificate may use 
% certificate usage XYZ and it should be process like "ABC".
